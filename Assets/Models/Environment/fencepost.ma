...
//Name: fencepost.ma
//Last modified: Sun, May 03, 2015 02:35:19 PM
//Codeset: 1252
requires maya "2015";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -8.9841126925501289 31.931191111614712 10.822812258642564 ;
	setAttr ".r" -type "double3" -57.938352728935982 317.00000000001035 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 28.422616331957961;
...
connectAttr "wood2SG.mwc" "pCube7Shape.iog.og[0].gco";
...
connectAttr "polySurfaceShape1.iog" "wood1SG.dsm" -na;
...
connectAttr "pCube7Shape.iog.og[0]" "wood2SG.dsm" -na;
...
connectAttr "groupId14.msg" "wood2SG.gn" -na;
